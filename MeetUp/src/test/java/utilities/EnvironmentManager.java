...
public class EnvironmentManager {
    //we will use this class to set up all the env var-s
    //our env-s will have diff urls,user credentials,api endpoints
    ...
    public static void setUpEnvironment()throws Exception{
        switch (ConfigReader.getProperty("environment").toLowerCase()){
            ...
            case "prod":
                ...
                break;
            default:
                //here u can set qa env to be default
